...
for i in range(n):
    ...
    if (p1 == 'ChongChong' or p2 == 'ChongChong') and isChongChong == False:
        dancingPeople.add(p1)
        dancingPeople.add(p2)
        isChongChong = True

    elif isChongChong == False:
        continue

    if not p1 in dancingPeople and not p2 in dancingPeople:
        pass
    else:
        dancingPeople.add(p1)
        dancingPeople.add(p2)

print(len(dancingPeople))
