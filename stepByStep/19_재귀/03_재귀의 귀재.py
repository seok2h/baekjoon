...
def recursion(string, l, r, t=None):
    if l >= r:
        return 1, t
    elif string[l] != string[r]:
        return 0, t
    else:
        return recursion(string, l+1, r-1, t+1)

def isPalindrome(string, t=None):
    return recursion(string, 0, len(string)-1, t)

n = int(sys.stdin.readline())

for _ in range(n):
    string = sys.stdin.readline().strip()
    print(*isPalindrome(string, 1))